...
function attachZoomHandlers(gs, syncOpts, prevCallbacks) {
  ...
  for (var i = 0; i < gs.length; i++) {
    ...
    g.updateOptions({
      drawCallback: function(me, initial) {
        ...
        for (var j = 0; j < gs.length; j++) {
         ...
         //     prevCallbacks[j].drawCallback.apply(this, arguments);	// this leads to too many updates and huge lag
            }
            continue;
          }
   ...
   //     	  console.log("is uptodate: "+j);  
        	  continue;
          }
     //     console.log("update: "+j);  
          gs[j].updateOptions(opts,false);
        }
        var d2=new Date().getTime();
        console.log("draw time: "+(d2-d1)+"ms for "+k);
        block = false;
      }
